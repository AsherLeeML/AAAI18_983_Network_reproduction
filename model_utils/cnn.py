...
class cnn:
    def __init__(self,
                 weight_stddev=0.1, bias_constant=0.1,
                 padding='SAME'):
    ...
    def apply_conv3d(self, x, kernel_depth, kernel_height, kernel_width, in_channels, out_channels, kernel_stride):
        weight = self.weight_variable([kernel_depth, kernel_height, kernel_width, in_channels, out_channels])
        bias = self.bias_variable([out_channels])
